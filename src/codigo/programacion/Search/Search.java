 ...
 */
package codigo.programacion.Search;
 ...
 * @author HugoLuna
 */
public class Search extends javax.swing.JFrame implements Go, init {
     ...
     */
    public Search(User user, String text) {
        this.user = user;
        this.text = text;
        initComponents();
        initViews();
    ...
    public void initViews() {
        ...
        try {
            ...
            String consulta = "SELECT * FROM curso WHERE nombre LIKE '%" + text + "%'";
